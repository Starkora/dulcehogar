...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 bg-gray-800 text-white px-4 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        ¡Haz tu pedido!
      </span>
    </a>
  );
